...
module.exports = {
    ...
    checkLoggedInIndex: function (req, res, next) {
        var module = "checkLoggedInIndex";

        if (req.customData.theUser.loggedInIndex == 1) {
            consoleLogger(successLogger(module));
            next();
        } else {
            res.redirect("index.html");
    ...
    checkLoggedInIndexAngular: function (req, res, next) {
        var module = "checkLoggedInIndexAngular";
