angular.module('grillApp')
    .controller('AvailableModalController', ['$q', '$window', '$location', '$log', '$scope', '$rootScope', '$interval', '$modalInstance', 'globals', 'grillStatusService', 'ReferenceService', 'EditService',
        function ($q, $window, $location, $log, $scope, $rootScope, $interval, $modalInstance, globals, grillStatusService, ReferenceService, EditService) {
    ...
    .controller('ConfirmCloseGrillModalController', ['$q', '$window', '$location', '$log', '$scope', '$rootScope', '$interval', '$modalInstance',
        function ($q, $window, $location, $log, $scope, $rootScope, $interval, $modalInstance) {
