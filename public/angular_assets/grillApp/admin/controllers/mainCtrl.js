angular.module('grillApp')
    .controller('MainController', ['$q', '$filter', '$interval', '$window', '$location', '$log', '$scope', '$rootScope', 'socket', 'mainService', 'socketService', 'globals',
        function ($q, $filter, $interval, $window, $location, $log, $scope, $rootScope, socket, mainService, socketService, globals) {
