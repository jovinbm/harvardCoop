angular.module('grillApp')
    .controller('IncomingController', ['$q', 'socket', '$filter', '$window', '$location', '$log', '$scope', '$rootScope', '$interval', '$modal', 'globals', 'grillStatusService', 'ReferenceService', 'EditService', 'socketService',
        function ($q, socket, $filter, $window, $location, $log, $scope, $rootScope, $interval, $modal, globals, grillStatusService, ReferenceService, EditService, socketService) {
